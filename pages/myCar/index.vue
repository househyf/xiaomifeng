<template>
	<d2-container>
			...
			<view class="oneShop">
				...
				<view  v-for="(shop,index) in carList" :key="shop.value" class="shopBox">
					<view class="shopTitleBox">
						<checkbox :value="shop.id" color="orange" style="transform:scale(0.7)" :checked="shop.checked" @click="setShop(shop,index)"/>
						<span class="shopTitle">
							{{shop.name}}
						</span>
					</view>
					<view  v-for="(product,index1) in shop.productList" :key="product.value" class="productBox">
						<checkbox :value="product.value" :checked="product.checked" style="transform:scale(0.7)"
		...
		<view class="setAccount">
			<view>
				<checkbox :checked="checkAll" style="transform:scale(0.7)" @click="selectAll"/>
				<span class="shopTitle" >
					全选
				</span>
			</view>
